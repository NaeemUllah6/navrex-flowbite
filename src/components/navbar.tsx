  ...
  return (
    <Navbar fluid>
      <div className="w-full p-3 lg:px-5 lg:pl-3">
        <div className="flex items-center justify-end lg:w-[calc(100%-255px)]">
  ...
  return (
    ...
    >
      <Dropdown.Header className="flex items-center gap-2">
        ...
        <div>
          <span className="block text-sm">Olivia Rhye</span>
          <span className="block truncate text-sm font-medium">
            olivia@untitledui.com
          </span>
        </div>
      </Dropdown.Header>
      <Dropdown.Item icon={FaClipboard}>Test Bank</Dropdown.Item>
      <Dropdown.Item icon={GoLink}>Links</Dropdown.Item>
      <Dropdown.Item icon={FaCartShopping}>Orders</Dropdown.Item>
      <Dropdown.Item icon={HiMiniLifebuoy}>History</Dropdown.Item>
      <Dropdown.Item icon={PiCurrencyDollarSimple}>Billing</Dropdown.Item>
      <Dropdown.Divider />
      <Dropdown.Item icon={FiLogOut}>Log out</Dropdown.Item>
    </Dropdown>
  );
};
