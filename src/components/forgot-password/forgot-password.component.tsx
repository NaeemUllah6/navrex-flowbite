        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:h-screen">
            ...
            <div className="w-full md:w-[50%] flex items-center justify-center px-4 md:px-[72px] py-10">
                <form id="loginForm" className="max-w-[577px] w-full mx-auto">
                    ...
                    <h2 className="text-xl font-bold text-[#111928] mt-6">Reset you Password</h2>
                    <p className="mt-1 text-sm md:text-base text-[#6B7280]">We’ll email you instructions to reset your password. If you don’t have access to your email anymore, you can try <Link className="text-[#995B2C]" to="#">account recovery</Link>.</p>
                    <div className="mt-6">
                        <InputWithLabel
                            labelText="Email"
                            id="email"
