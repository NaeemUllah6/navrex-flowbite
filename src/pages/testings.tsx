...
const DataIntegrationPage: FC = function () {
  const card_items = [
    {
      title: "Test Selector (Automated)",
      description:
        "Highest-yield neuropsych tests algorithmically selected from clinical history",
    },
    {
      title: "Test Selector (Manual)",
      description:
        "Clinician selected neuropsych tests for customized or fixed battery",
    },
    {
      title: "File Import",
      description: "Automated importation of raw data and results files",
    },
  ];
